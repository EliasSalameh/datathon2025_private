...
def get_predictions(data_path: str, llm_output_path: Path):
    ...
    for client_dir in tqdm(sorted_clients):   
        ...
        if client_dir == Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_14"):
            client_dir = Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_14/client_14")
        if client_dir == Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_452"):
            client_dir = Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_452/client_452")
        if client_dir == Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_485"):
            client_dir = Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_485/client_485")
        if client_dir == Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_690"):
            client_dir = Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_690/client_690")
        if client_dir == Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_965"):
            client_dir = Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_965/client_965")
        if client_dir == Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_994"):
            client_dir = Path("/home/elias/Anatomic-Diffusion-Models/data_test/clients/client_994/client_994")
